	  ...
	  <div class="card">
		...
		<div class="card-body">
			...
			<div>
			  ...
			  <form class="w-100" id="new_comment" action="{{route('comments.store', $post->id)}}" accept-charset="UTF-8" data-remote="true" method="post"><input name="utf8" type="hidden" value="&#x2713;" />
					 @csrf
